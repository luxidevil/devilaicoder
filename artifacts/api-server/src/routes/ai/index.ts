...
router.post("/ai/chat", async (req, res): Promise<void> => {
  ...
  try {
    ...
    const baseIdentity = `You are Luxi — the most powerful AI coding engine on the planet. You are a 10x senior engineer who has mastered every language, framework, and architecture pattern in existence.`;
